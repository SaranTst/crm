			  ...
			  <div class="card-body">
			  	<form id="frm_serach" onsubmit="return false;">
				  	<div class="row">
				  		...
				  		<div class="form-group">
		                    <label>Keyword</label>
		                    <input type="text" class="form-control" placeholder="Enter a keyword (Admin name, Nickname)" name="keyword">
	                  	</div>
				  		</div>
				  	</div>
				</form>
			...
			<div class="card">
			  ...
			  <div class="card-body">
			  	<div class="row mb-3">
			  		...
			  		<div class="col-md-6">
			  			<div class="float-right" id="pagination-admins"></div>
			  		</div>
			  	</div>
			  		...
			  		<div class="col-md-4 mb-3">
			  			<div class="card">
			  			  ...
			  			  <div class="card-header pt-0 pb-0">
	      					  ...
	      					  <a href="<?php echo base_url().'admins/update_admin/'.$value['ID']; ?>" id="link-update"><i class="fa fa-pencil-square-o fa-lg float-right p-1 my-1 mr-2" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
					  	  </div>
        ...
        <div class="modal-content">
            <div class="modal-header pb-2">
                ...
                <div class="row" id="header-table">
					<div class="col-md-4">
					  <a href="javascript:void(0)" class="btn crm-btn-dark-gray btn-lg btn-block no-hover"><i class="fa fa-user fa-fw"></i><p>&nbsp; Admins Contact</p></a>
					</div>
				</div> <!-- #header-table -->
				</div>
  ...
  <script type="text/javascript">
  	...
  	$(document).ready(function(){ 
		...
		function ajax_data(pageNumber=1) {
		    ...
		    var url = base_url+'api/admins/lists_admins?page='+pageNumber;
	            ...
	            success: function( resp ){
	                ...
	                if (resp.status==1) {
	                	...
	                	$.each(data, function(i, v){
	                		...
	                		content_result.find('#link-update').attr('href', base_url+'admins/update_admin/'+v.ID);
		...
		function ajax_delete(id) {
		    ...
		    var url = base_url+'api/admins/delete_admins/'+id;
		    var formData = {};
	        ...
	        $.ajax({
	            ...
	            success: function( resp ){
	                ...
	                if (resp.status==1) {
						...
						ajax_data($('#pagination-admins').pagination('getCurrentPage'));
	                }else{
						Swal.fire({
							title: 'Warning!',
							text: resp.message,
		...
		function set_pagination(currentpage=1,total,limit) {
		    ...
		    $('#pagination-admins').pagination('drawPage', currentpage);
