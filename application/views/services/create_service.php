            ...
            <div class="container-fluid">
              ...
              <div class="row">
                <div class="col-md-3 mb-3">
                  <div class="z-depth-1-half text-center">
                    <img src="<?php echo sizeof($data)>0&&$data['IMAGE'] ?  base_url().$data['IMAGE'] : base_url().'images/180.png'; ?>" id="preview-add-services" class="img-thumbnail" style="height: 180px;">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Upload Image" name="image" id="show-file-name-add-services" value="<?php echo sizeof($data)>0 ? $data['IMAGE'] : ''; ?>" readonly>
                        <ul class="mb-4">
                    ...
                    <div class="col-md-12">
                      <input id="input-file-add-services" type="file" class="form-control" accept="image/*" style="visibility: hidden; position: absolute;">
                      <button type="button" class="btn crm-btn-gray btn-lg btn-block" style="border-radius: 0;" id="btn-upload-file-add-services" onclick="upload_and_preview_ajax('input-file-add-services' ,'show-file-name-add-services' ,'preview-add-services')"><i class="fa fa-upload" style="padding-right: 10px;"></i>Upload Image</button>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4 mb-2 text-center">
                  ...
                  <a href="javascript:void(0)" class="btn crm-btn-orange btn-lg btn-block" id="insert-services"><p>SAVE</p></a>
                </div>
                <div class="col-md-4"></div>
              </div>
  ...
  $(document).ready(function(){ 
    ...
    $('#insert-services').click(function(e) {
      var url = base_url+'api/services/update_services/'+id;
      var formDataService = checkForm('add-services');
    ...
    $("input", $("form#add-services")).on("keyup", function(){
      $(this).removeClass("border border-danger").siblings("small.text-danger").css("display","none");
    })
    $("select", $("form#add-services")).on("change", function(){
      $(this).removeClass("border border-danger").siblings("small.text-danger").css("display","none");
    })
