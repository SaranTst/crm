			  ...
			  <div class="card-body">
			  	<form id="frm_serach" onsubmit="return false;">
				  	<div class="row">
				  		...
				  		<div class="form-group">
		                    <label>Keyword</label>
		                    <input type="text" class="form-control" placeholder="Enter a keyword (Service name, Nickname)" name="keyword">
	                  	</div>
				  		</div>
				  	</div>
				</form>
			...
			<div class="card">
			  ...
			  <div class="card-body">
			  	<div class="row mb-3">
			  		...
			  		<div class="col-md-6">
			  			<div class="float-right" id="pagination-services"></div>
			  		</div>
			  	</div>
			  		...
			  		<div class="col-md-4 mb-3">
			  			<div class="card">
			  			  ...
			  			  <div class="card-header pt-0 pb-0">
	      					  ...
	      					  <a href="<?php echo base_url().'services/update_service/'.$value['ID']; ?>" id="link-update"><i class="fa fa-pencil-square-o fa-lg float-right p-1 my-1 mr-2" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
					  	  </div>
						  <div class="card-body" onclick='show_contact_sales(<?php echo json_encode($value); ?>)'>
						  	<div class="row">
						  		...
						  		<div class="col-md-8">
					  				<p class="crm-card-sale-text crm-card-sale-text-2dark-blue" id="txt-department"><b><?php echo ARR_DEPARTMENT_SERVICE[$value['DEPARTMENT_ID']]; ?></b></p>
        ...
        <div class="modal-content">
            <div class="modal-header pb-2">
                ...
                <div class="row" id="header-table">
					<div class="col-md-4">
					  <a href="javascript:void(0)" class="btn crm-btn-dark-gray btn-lg btn-block no-hover"><i class="fa fa-user fa-fw"></i><p>&nbsp; Services Contact</p></a>
					</div>
				</div> <!-- #header-table -->
				</div>
...
<!-- 							<div class="form-group row mb-0">
  ...
  <script type="text/javascript">
  	...
  	var ARR_DEPARTMENT_SERVICE = <?php echo json_encode(ARR_DEPARTMENT_SERVICE); ?>;
  	...
  	$(document).ready(function(){ 
	    ...
	    function show_contact_sales(values) {
			...
			$('#sale_contact_modal').find('#modal-department').text(ARR_DEPARTMENT_SERVICE[values.DEPARTMENT_ID]);
		...
		function ajax_data(pageNumber=1) {
		    ...
		    var url = base_url+'api/services/lists_services?page='+pageNumber;
	            ...
	            success: function( resp ){
	                ...
	                if (resp.status==1) {
	                	...
	                	$.each(data, function(i, v){
	                		...
	                		content_result.find('#txt-department').html('<b>'+ARR_DEPARTMENT_SERVICE[v.DEPARTMENT_ID]+'</b>');
	        ...
	        $.ajax({
	            ...
	            success: function( resp ){
	                ...
	                if (resp.status==1) {
						...
						ajax_data($('#pagination-services').pagination('getCurrentPage'));
	                }else{
						Swal.fire({
							title: 'Warning!',
							text: resp.message,
		...
		function set_pagination(currentpage=1,total,limit) {
		    ...
		    $('#pagination-services').pagination('drawPage', currentpage);
