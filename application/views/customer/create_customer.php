                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group row">
                      <!-- Left column -->
                      <div class="col-xl-6 col-lg-4 col-sm-3"></div>
                      <!-- Right column -->
                      <label class="col-xl-2 col-lg-2 col-sm-2 col-form-label">Rating</label>
                ...
                <div class="row mt">
                  <div class="col">
                    <div class="form-group row">
                      ...
                      <!-- Right column -->
                      <label class="col-xl-3 col-lg-4 col-sm-4 col-form-label">Relationship</label>
